use utf8;
package Testbed::Spatial::VDS::Schema::Result::Hsis::Rodwycl;
...
=head1 TABLE: C<hsis.rodwycls>

=cut

__PACKAGE__->table("hsis.rodwycls");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:FlneTNkevvNyC4wE6zfIHQ
