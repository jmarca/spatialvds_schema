use utf8;
package Testbed::Spatial::VDS::Schema::Result::Public::GeomPoints4269;
...
=head1 TABLE: C<public.geom_points_4269>

=cut

__PACKAGE__->table("public.geom_points_4269");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:g9htKypXFx9/b94qj9UEew
