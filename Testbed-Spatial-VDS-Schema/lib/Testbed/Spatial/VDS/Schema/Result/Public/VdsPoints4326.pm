use utf8;
package Testbed::Spatial::VDS::Schema::Result::Public::VdsPoints4326;
...
=head1 TABLE: C<public.vds_points_4326>

=cut

__PACKAGE__->table("public.vds_points_4326");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:xLK10E/0aTuHAR4HMHIx6g
