use utf8;
package Testbed::Spatial::VDS::Schema::Result::Public::WimPoints4269;
...
=head1 TABLE: C<public.wim_points_4269>

=cut

__PACKAGE__->table("public.wim_points_4269");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:q/T/GPBDMTZ7hQeOIOkO+A
