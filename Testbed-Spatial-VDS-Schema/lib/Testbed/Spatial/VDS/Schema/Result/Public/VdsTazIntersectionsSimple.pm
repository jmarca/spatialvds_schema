use utf8;
package Testbed::Spatial::VDS::Schema::Result::Public::VdsTazIntersectionsSimple;
...
=head1 TABLE: C<public.vds_taz_intersections_simple>

=cut

__PACKAGE__->table("public.vds_taz_intersections_simple");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+z9zEvzaYHW6oBLd8pih1A
