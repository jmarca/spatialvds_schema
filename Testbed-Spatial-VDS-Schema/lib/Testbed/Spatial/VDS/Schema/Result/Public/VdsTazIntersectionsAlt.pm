use utf8;
package Testbed::Spatial::VDS::Schema::Result::Public::VdsTazIntersectionsAlt;
...
=head1 TABLE: C<public.vds_taz_intersections_alt>

=cut

__PACKAGE__->table("public.vds_taz_intersections_alt");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:XaEE/x1/Y1oyNILl+k301g
