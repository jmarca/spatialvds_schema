use utf8;
package Testbed::Spatial::VDS::Schema::Result::Public::VdsStat;
...
=head1 TABLE: C<public.vds_stats>

=cut

__PACKAGE__->table("public.vds_stats");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ayYzlSNpmIaUcHBcmD/UIg
